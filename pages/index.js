          ...
          <div className='row'>
            <div className='col-12 col-lg-8 mx-auto'>
              ...
              <Image className="card-img-top" src={image} alt="Card image" width={150} height={400}/>
                ...
                <div className='text-start'> <h3 style={{ color: '#fff', fontSize: '1.5rem', marginBottom: '1rem' }}>Eligibility Criteria</h3>
  
                  <ul>
                  <ul style={{ listStyleType: 'none', paddingLeft: 0 }}> {/* Apply inline styles */}
                          <li style={{ color: '#fff', fontSize: '1rem', marginBottom: '0.5rem' }}>New wallets cannot participate</li>
                          <li style={{ color: '#fff', fontSize: '1rem', marginBottom: '0.5rem' }}>Your wallet must have transactions</li>
                          <li style={{ color: '#fff', fontSize: '1rem', marginBottom: '0.5rem' }}>You must confirm that you are the owner of the wallet</li>
                          <li style={{ color: '#fff', fontSize: '1rem', marginBottom: '0.5rem' }}>You must have Ethereum for gas fees available in your wallet</li>
                        </ul>
